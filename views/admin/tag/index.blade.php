      ...
      <div class="row">
        <div class="col-md-6">
          @can('isAdmin')
            ...
            @else
            <a href="{{ route('tag.create') }}" class="btn btn-primary disabled" data-toggle="tooltip" title="Create"><i class="fa fa-plus"></i>&nbsp;Add Tag</a>
            @endcan
        </div>
      </div>
      <h4 class="py-3 mb-0">
            ...
            <tbody class = "table-group-divider">
              ...
              <tr>
                ...
                <td class="text-center">
                  ...
                  @else
                  <a href="{{ route('tag.edit' , $tag->id) }}" class="btn btn-info btn-flat btn-sm disabled"><i class="fa fa-edit"></i></a>
                  <a href="{{ route('tag.delete' , $tag->id) }}" class="btn btn-danger btn-flat btn-sm disabled singleDelete" onclick ="return confirm('Are You Sure..??')"><i class="fa fa-trash"></i></a>
                  @endcan
