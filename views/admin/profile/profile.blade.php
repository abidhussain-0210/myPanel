          ...
          <div class="card mb-4">
            ...
            <div class="user-profile-header d-flex flex-column flex-sm-row text-sm-start text-center mb-4">
              <div class="flex-shrink-0 mt-n2 mx-sm-0 mx-auto">
                <img src="/uploads/{{ Auth::user()->image }}" alt="user image" style="width:130px; border:5px solid #fff;" class="d-block h-auto ms-0 ms-sm-4 rounded img-thumbnail user-profile-img">
              </div>
                  ...
                  <div class="user-profile-info">
                    ...
                    <ul class="list-inline mb-0 d-flex align-items-center flex-wrap justify-content-sm-start justify-content-center gap-2">
                      <li class="list-inline-item fw-medium">
                        <i class='bx bx-map'></i> {{ Auth::user()->state }} , {{ Auth::user()->country }}
                      </li>
                      <li class="list-inline-item fw-medium">
                        <i class='bx bx-calendar-alt'></i> {{ Auth::user()->created_at }}
                      </li>
                    </ul>
                  </div>
                </div>
...
<!--/ Navbar pills -->
    ...
    <div class="row">
        ...
        <div class="card mb-4">
          <div class="card-body">
            ...
            <ul class="list-unstyled mb-4 mt-3">
              <li class="d-flex align-items-center mb-3"><i class="bx bx-user"></i><span class="fw-medium mx-2">Full Name:</span> <span>{{ Auth::user()->first_name }} {{ Auth::user()->last_name }}</span></li>
              ...
              <li class="d-flex align-items-center mb-3"><i class="bx bx-flag"></i><span class="fw-medium mx-2">State:</span> <span>{{ Auth::user()->state }}</span></li>
              <li class="d-flex align-items-center mb-3"><i class="bx bx-detail"></i><span class="fw-medium mx-2">Languages:</span> <span>{{ Auth::user()->language }}</span></li>
            </ul>
    
            <small class="text-muted text-uppercase">Contacts</small>
            <ul class="list-unstyled mb-4 mt-3">
              <li class="d-flex align-items-center mb-3"><i class="bx bx-phone"></i><span class="fw-medium mx-2">Address:</span> <span>{{ Auth::user()->address }}</span></li>
              <li class="d-flex align-items-center mb-3"><i class="bx bx-phone"></i><span class="fw-medium mx-2">Contact:</span> <span>{{ Auth::user()->phone_number }}</span></li>
      ...
      <div class="button-wrapper">
        <a class="btn btn-primary mb-4" href="{{ route('profile.setting') }}">Edit Profile</a>
