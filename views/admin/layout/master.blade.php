...
<!-- Mirrored from demos.themeselection.com/sneat-bootstrap-html-admin-template/html/vertical-menu-template/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 06 Jan 2024 00:18:31 GMT -->
<head>
    <meta charset="utf-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0, user-scalable=no, minimum-scale=1.0, maximum-scale=1.0" />

    <title>@yield('page-title') | Sneat</title>
    ...
    <!-- Favicon -->
    <link rel="icon" type="image/x-icon" href="https://demos.themeselection.com/sneat-bootstrap-html-admin-tem/assets/admin/img/favicon/favicon.ico" />
...
<div class="layout-wrapper layout-content-navbar  ">
  ...
  <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    ...
    <div class="app-brand demo ">
      <a href="{{ route('blog.index') }}" class="app-brand-link">
    ...
    <ul class="menu-inner py-1">
      ...
      <li class="menu-item">
        <a href="javascript:void(0);" class="menu-link menu-toggle">
          <i class='menu-icon tf-icons bx bx-cart-alt'></i>
          <div class="text-truncate" data-i18n="Tags">Tags</div>
        </a>
        <ul class="menu-sub">
          <li class="menu-item">
            <a href="{{ route('tag.index') }}" class="menu-link">
              <div class="text-truncate" data-i18n="Tags List">Tags List</div>
            </a>
          </li>
          <li class="menu-item">
            <a href="{{ route('tag.create') }}" class="menu-link">
              <div class="text-truncate" data-i18n="Add Tags">Add Tags</div>
            </a>
          </li>
        </ul>
      </li>
          ...
          <li class="nav-item navbar-dropdown dropdown-user dropdown">
            <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);" data-bs-toggle="dropdown">
              <div class="avatar avatar-online">
                <img src="/uploads/no-img.jpg" alt class="w-px-40 h-auto rounded-circle">
              </div>
            </a>
            <ul class="dropdown-menu dropdown-menu-end">
                ...
                <a class="dropdown-item" href="{{ route('user.profile') }}">
                  <div class="d-flex">
                    ...
                    <div class="flex-grow-1">
                      <span class="fw-medium d-block">Abid Hussain</span>
              ...
              <li>
                <a class="dropdown-item" href="{{ route('user.acount.setting') }}">
  ...
  <!-- Footer start -->
  <footer class="content-footer footer bg-footer-theme py-2">
  <div class="container-fluid text-center">
    <div class="row justify-content-center">
      <div class="col-12">
        © <script>document.write(new Date().getFullYear())</script>, Made With ❤️ By <a href="#" target="_blank" class="footer-link fw-medium">Abid Hussain Ansari</a>
      </div>
    </div>
  </div>
</footer>
